...
@section('content')
    <section id="potensi" class="container mx-auto pb-5 flex justify-center align-content-center">
        <h2 class="text-center my-5 blue-title text-capitalize fw-bold display-4">potensi UMKM</h2>
        <div class="album my-4" id="potensi">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 mx-auto">
                    <div class="col mb-4">
                        <div class="potensi mx-auto" style="width: 85%;">
                  ...
                  <div class="col mb-4">
                    <div class="potensi mx-auto" style="width: 85%;">
                        <img src="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=465&q=85" class="m-sm-0 m-md-0 m-lg-0 card-img-top rounded-circle object-fit-cover" alt="..." width="50%" height="200">
                        <div class="card-body mt-3 text-center">
