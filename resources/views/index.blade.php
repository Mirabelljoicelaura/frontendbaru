...
@section('content')
    ...
    <div class="container-xxl py-5">
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-8">
                <h1 class="mb-4">SAMBUTAN <span class="text-primary text-uppercase">KETUA RW 05</span></h1>
                ...
                <p>
                  ...
                  <span class="badge rounded-pill text-bg-primary">#TanjungrejoDisiniAja</span>
                  <span class="badge rounded-pill text-bg-primary">#TidakKemana-ManaAdaDimana-Mana</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <h1>Organisasi Masyarakat</h1>
        <section class="relative">
            <div id="carouselExampleRide2" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1700">
                <div class="ormas carousel-inner">
                    <div class="carousel-item active">
                        <div class="cards-wrapper">
                            <div class="ormas card">
                                <img src="https://images.unsplash.com/photo-1613395940640-9c2d79562bf7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                                class="d-block w-100" alt="..." style="height:600px; object-fit: cover;">
                              <div class="card-body">
                    ...
                    <div class="carousel-item">
                        <div class="cards-wrapper">
                            <div class="ormas card">
                                <img src="https://media.istockphoto.com/id/1164624416/photo/malaysia-hawker-culture-clay-pot-chicken-rice-stock-photo.jpg?b=1&s=170667a&w=0&k=20&c=65L8gxjLg-jpXtSSJVp3wT8c2Z5LL_eMkFTW8DVx9Bk=&auto=format&fit=crop&w=400&h=280&q=80"
                                class="d-block w-100" alt="..." style="height:600px; object-fit: cover;">
                              <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                ...
                <button class="ormas carousel-control-prev" type="button" data-bs-target="#carouselExampleRide2" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="ormas carousel-control-next" type="button" data-bs-target="#carouselExampleRide2" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
            </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 mx-auto">
                <div class="col">
                    <div class="potensi mx-auto" style="width: 80%;">
                        <img src="https://images.unsplash.com/photo-1555126634-323283e090fa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80" class="m-sm-0 m-md-0 m-lg-0 potensi-img card-img-top rounded-circle object-fit-cover" alt="..." width="200" height="200">
                ...
                <div class="col">
                  <div class="potensi mx-auto" style="width: 80%;">
                      <img src="https://images.unsplash.com/photo-1567982047351-76b6f93e38ee?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" class="m-sm-0 m-md-0 m-lg-0 potensi-img card-img-top rounded-circle object-fit-cover" alt="..." width="50%" height="200">
                      <div class="card-body mt-3 text-center">
